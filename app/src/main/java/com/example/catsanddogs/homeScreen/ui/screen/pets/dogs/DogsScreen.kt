...
import com.example.catsanddogs.homeScreen.ui.screen.composables.AlertDialogDeleteDog
...
@Composable
fun DogsScreen(
    viewModel: DogsScreenViewModel = hiltViewModel(),
    ...
    LaunchedEffect(Unit) {
        viewModel.retrieveOnlineDogImages(context = localContext)
        sharedViewModel.deselectImage()
        viewModel.retrieveLocalDogImages()
    }
    ...
    Box(
        ...
        LazyVerticalStaggeredGrid(
            ...
            items(stateViewModel.pets) { dog ->
                val filePath = imageMapLocal[dog.id]
            ...
            item {
                ButtonCard(
                    addPet = {
                        sharedViewModel.addingNewPet("dog")
